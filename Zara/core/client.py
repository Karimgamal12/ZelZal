                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @p_m_4\
                                  \n\n--------بـدء تتبـع سجـل لــيدر ●○𝗟𝗘𝗮𝗗𝗲𝗥○●--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع لــيدر ●○𝗟𝗘𝗮𝗗𝗲𝗥○●--------"
                        ...
                        link = "[زيـــــــٌن اݪــتأࢪيخ 🚸](https://t.me/p_m_4)"
                        text = (
                            "**✘ تقـريـر اشعـار لــيدر ●○𝗟𝗘𝗮𝗗𝗲𝗥○● ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار لــيدر ●○𝗟𝗘𝗮𝗗𝗲𝗥○● ✘**\n\n "
                        link = "[زيـــــــٌن اݪــتأࢪيخ 🚸](https://t.me/p_m_4)"

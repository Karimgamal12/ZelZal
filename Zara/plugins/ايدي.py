...
zed_dev = (5176749470, 5593884330, 5593884330, 5593884330, 5426390871)
zel_dev = (5176749470, 5426390871)
zelzal = (5593884330, 5593884330, 5593884330)
...
# الـرتب الوهميـه & فارات الكليشـه & البريميـوم & عـدد الرسـائل & التفاعـل = كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l / خاصـه بسـورس - لــيدر @ZThon فقـط
...
################# Dev ZilZal #################
    if user_id in zelzal: #Code by T.me/zzzzl1l
        ...
        rotbat = "⌁ العضـو 𓅫 ⌁"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت لــيدر"  #Code by T.me/zzzzl1l
    ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " #Code by T.me/zzzzl1l
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ ˡᵉᵃᵈᵉʳ ─┄─┄─┄─⋆" #Code by T.me/zzzzl1l

...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗘𝗮𝗗𝗲𝗥 - اوامــر المطـور المســاعد](t.me/V_P_N_8) 𓆪\n\n"
    ...
    "\n𓆩 [𝙼𝙾𝙽𝚉𝙴𝚁 𖠮🚸 الهہـيـٖ͡ـ͢ـبـه𖠮𝗟𝗘𝗮𝗗𝗲𝗥](t.me/Z_X_Z_B) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت لــيدر انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت لــيدر انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
